<template>
  <div class="services">
    ...
    <div class="text">
      ...
      <div class="paragraph">
        <img class="img-right" src="./../assets/services_background.jpg" height="108px" width="192px"> 
        <div>
      ...
      <div class="paragraph"> 
        <img class="img-left top-padding" src="./../assets/computer.png" height="116px" width="134px"> 
